...
#include "aumhaa.shaderFun.cpp"    // need the source of our object so that we can access it
...
SCENARIO("object produces correct output") {
    ...
    GIVEN("An instance of our object") {
        ...
        test_wrapper<aumhaa_shaderFun> an_instance;
        aumhaa_shaderFun&              my_object = an_instance;
